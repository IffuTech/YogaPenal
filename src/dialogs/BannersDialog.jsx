...
export default function BannersDialog(props) {
    ...
    if (props?.id) {
        ...
        formData.append('bannerId', userdata?._id);
    } else {
        formData.append('image', selectedImage);
        formData.append('title', userdata?.title);
        formData.append('priorityNo', userdata?.priorityNo);
...
console.log(props?.id);
    const handleSubmit = async (e) => {
        ...
        try {
            let url;
            if (props?.id) url = `${API_ENDPOINT}/api/update/banner`
            else url = `${API_ENDPOINT}/api/create/banner`
    ...
    return (
        <div>
            <Dialog open={open} onClose={() => { onClose(); setUserData({}) }}>
                <DialogTitle>{props?.id ? "Update Banner" : "Add Banner"}</DialogTitle>
